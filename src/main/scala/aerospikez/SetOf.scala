...
private[aerospikez] class SetOf[@specialized(Int, Long) V](namespace: Namespace, setName: String, async: AsyncClient) {
  ...
  def get[K: SupportKey, V2](
    key: K, bin: String)(implicit ev: V2 DefaultValueTo V): Task[Option[V2]] = {

    setOp.get[V2](queryPolicy, getKey[K](key), bin)
  }

  def get[K: SupportKey, V2](
    keys: Array[K])(implicit k: distinctKey1.type, ev: V2 DefaultValueTo V): Task[OHMap[K, V2]] = {
